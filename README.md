...
description: Fork of apache inappbrowser v 4.0.1-dev
---
<!--
...
This is a fork of cordova-plugin-inappbrowser 4.0.1-dev with a change to remove status bar overlay from iOS, add Android status bar overlays web view support and add extra statusbarstyle option
...
- __options__: Options for the `InAppBrowser`. Optional, defaulting to: `location=yes`. _(String)_
    ...
    - __statusbartransparent__: Set to 'yes' for statusbar transparent and overlaying content. Default 'no'. Does not work with fullscreen=yes.
    ...
    - __statusbarstyle__: Default 'dark' for black color over light content. Set to 'light' for white color over dark content.
    - __statusbartransparent__: Set to 'yes' for statusbar transparent and overlaying content. Default 'no'.
